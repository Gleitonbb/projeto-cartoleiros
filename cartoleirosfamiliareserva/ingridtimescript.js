...
function verificar1() {
  ...
  if (dataAtual1 <= dataEncerramento) {
    if (time1 === TimeGanhador1) {
      res1.innerHTML = `O <strong>${time1}</strong> ganhou`;
      marcacao1.resultado1 = 'ganhou';
    } else {
      res1.innerHTML = `O <strong>${time1}</strong> perdeu`;
      marcacao1.resultado1 = '<strong>perdeu</strong>';
    }
...
function verificar2() {
  ...
  if (dataAtual2 <= dataEncerramento) {
    if (time2 === TimeGanhador2) {
      res2.innerHTML = `O <strong>${time2}</strong> ganhou`;
      marcacao2.resultado2 = 'ganhou';
    } else {
      res2.innerHTML = `O <strong>${time2}</strong> perdeu`;
